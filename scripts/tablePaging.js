...
$.prototype.extend(
	{
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
                ...
                var bordColor = defaults.brdrColor;
                
                var navPos = defaults.navigationPosition;
				...
				function createPaginationElements() {
					var paginationHTML = "";
					paginationHTML += "<div id='tablePagination' style='text-align: " + navPos + "; border-top: solid 2px " + bordColor + "; padding-top: 5px; padding-bottom: 5px;'>";
                ...
                function showAll() {
                    if (document.getElementById('showAll').checked) {
                        ...
                        resetCurrentPage($(currPageId).val());
                    }
                }
