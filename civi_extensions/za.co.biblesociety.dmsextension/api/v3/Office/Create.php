 ...
 */
function civicrm_api3_office_Create($params) {
    
    $instance = new CRM_Dmsextension_BAO_Office();
    $instance->create($params);
    $records = _civicrm_api3_basic_get('CRM_Dmsextension_BAO_Office', $params);
    $result = $records['values'];
    return civicrm_api3_create_success($result, $params, 'Office', 'Create');
