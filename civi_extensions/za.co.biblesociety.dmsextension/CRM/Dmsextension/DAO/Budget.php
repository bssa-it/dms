...
class CRM_Dmsextension_DAO_Budget extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_dms_budget';
  /**
...
/**
  ...
  {
    $this->__table = 'civicrm_dms_budget';
    parent::__construct();
  }
  /**
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['dms_budget'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['dms_budget'] = & $fields[$name];
          } else {
