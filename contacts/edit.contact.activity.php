...
$subject = $location = '';
$assignedTo_phone = $assignedTo_email = '';
            ...
            case 49:
                ...
                if (empty($activity['contacts']['assigned_to'])) {
                    ...
                    foreach ($activity['contacts']['assigned_to'] as $i=>$t) {
                        ...
                        $meetingRows .= '<tr><td>Assigned To</td><td colspan="2"><input type="text" name="assigned_to[]" placeholder="donor no" value="'.$d['external_identifier'].'" /><div class="addDiv">+ add</div></td></tr>';
                    }   
                }
                if (empty($activity['contacts']['with_contact_id'])) {
